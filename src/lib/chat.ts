...
export function scriptedReply(input: string): string {
  ...
  if (/price|cost|how much|\$|pricing/.test(q))
    return "Builds start at $800 for the Foundation, $1,500 for the Growth Engine, and $4,000+ for Custom Infrastructure. They're one-time, and the bigger builds include 30 days of monitoring. Want a free demo to see which fits?";
