...
export const scoutsLeadsDiagram: Diagram = {
  ...
  edges: [
    { id: "a1", source: "scouts", target: "mct", flow: "normal" },
    { id: "a2", source: "mct", target: "parser", flow: "normal" },
    ...
    { id: "a9", source: "uar", target: "lhe", flow: "normal" },
    ...
    { id: "a16", source: "scam", target: "db", flow: "normal" },
    { id: "a17", source: "scoring", target: "db", flow: "normal" },
    { id: "a18", source: "structuring", target: "db", flow: "normal" },
    ...
    { id: "a25", source: "commission", target: "dashboard", flow: "normal" },
  ],
};
