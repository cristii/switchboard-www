...
export const TypeScale: Story = {
  render: () => (
    <div style={{ maxWidth: 980, margin: "0 auto", padding: "40px 24px" }}>
      ...
      <p style={{ color: "var(--ink-soft)", maxWidth: "44em", margin: "0 0 24px" }}>
      ...
      <Row label="--fs-h2 / 800">
        <div style={{ font: "var(--type-h2)", letterSpacing: "var(--ls-display)" }}>
          The assistant earns its keep.
        </div>
      </Row>
      <Row label="--fs-h3 / 700">
        <div style={{ font: "var(--type-h3)" }}>AI Chatbot Architecture</div>
      </Row>
      ...
      <Row label="--fs-sm / 400">
        <p style={{ fontFamily: "var(--font-body)", fontSize: "var(--fs-sm)", margin: 0, color: "var(--ink-soft)" }}>
